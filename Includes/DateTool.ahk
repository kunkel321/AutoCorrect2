...
; ==============================================================================
; Caveat: Claude AI was used in several places, so reuse the code with caution.
...
HotStrToolTipTimeout := 3.5         ; Seconds to show hotstring date tooltip
...
ShowToolTip(sDatePicked, iOff, sPeriod, sCode, sFormat, isWeekday := false, targetDay := 0) {
    ...
    SetTimer () => ToolTip(, , , "3"), -(HotStrToolTipTimeout * 1000) 
}
